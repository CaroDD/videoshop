...
class CustomerDataInitializer implements DataInitializer {
	...
	public void initialize() {
		...
		List.of(//
				new RegistrationForm("hans", password, "wurst", "hans@web.de"),
				new RegistrationForm("dextermorgan", password, "Miami-Dade County", "dex@gmx.de"),
				new RegistrationForm("earlhickey", password, "Camden County - Motel", "earl@uk.com"),
				new RegistrationForm("mclovinfogell", password, "Los Angeles", "losangeles@gmx.de")//
